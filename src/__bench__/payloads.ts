...
const naturalNumbersRandomLargeList = Array.from({length: 10000}, (_, i) => Math.floor(Math.random() * 10000));
// const naturalNumbersRandomVeryLargeList = Array.from({length: 100000}, (_, i) => Math.floor(Math.random() * 100000));
...
export const numbers = [
  ...
  {
    name: (json: any) => `Random ${naturalNumbersRandomLargeList.length} numbers`,
    data: naturalNumbersRandomLargeList,
  },
  // {
  //   name: (json: any) => `Random ${naturalNumbersRandomVeryLargeList.length} numbers`,
  //   data: naturalNumbersRandomVeryLargeList,
  // },
  {
    name: (json: any) =>
